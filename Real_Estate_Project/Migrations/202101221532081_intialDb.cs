namespace Real_Estate_Project.Migrations
{
    ...
    public partial class intialDb : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        userToRegister_ID = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.OperatingUsers", t => t.userToRegister_ID)
                .Index(t => t.UserName, unique: true, name: "UserNameIndex")
                .Index(t => t.userToRegister_ID);
        ...
        {
            DropForeignKey("dbo.AspNetUsers", "userToRegister_ID", "dbo.OperatingUsers");
            ...
            DropIndex("dbo.AspNetUsers", new[] { "userToRegister_ID" });
            DropIndex("dbo.AspNetUsers", "UserNameIndex");
            DropIndex("dbo.AspNetUserRoles", new[] { "RoleId" });
            DropIndex("dbo.AspNetUserRoles", new[] { "UserId" });
            DropIndex("dbo.AspNetRoles", "RoleNameIndex");
            DropTable("dbo.OperatingUsers");
